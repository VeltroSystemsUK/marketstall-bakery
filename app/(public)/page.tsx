...
const HOW_IT_WORKS = config.features.multiProducer
  ...
  : [
      {
        icon: Wheat,
        title: "Browse the bakery",
        body: "Explore our full range of slow-fermented sourdoughs, ancient grain loaves, and freshly laminated pastries — each one baked to order.",
      },
      {
        icon: ShieldCheck,
        title: "Order securely",
        body: "Checkout in seconds with Stripe-powered payment. Choose next-morning delivery or collect directly from the bakery.",
      },
      {
        icon: PackageCheck,
        title: "Baked and dispatched same morning",
        body: "We bake from 4am and dispatch by 8am. Your bread arrives fresh, never pre-packaged from a warehouse shelf.",
      },
    ];
    ...
    <>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center text-white">
          ...
          <div className="hero-animate delay-450 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            >
              Shop our bread <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
      ...
      <section className="relative overflow-hidden bg-forest-800 py-24">
        ...
        >
          ...
          >
            Shop our bread <ArrowRight className="h-5 w-5" />
          </Link>
        </div>
      </section>
    </>
